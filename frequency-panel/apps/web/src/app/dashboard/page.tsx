  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <header className="animate-fade-up flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold text-white">Controle de frequencia</h1>
          ...
          <button
            onClick={load}
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-white/[0.06] px-4 py-2 text-sm font-semibold text-white hover:bg-white/[0.1]"
          >
            <RefreshCw size={16} />
            Atualizar
          </button>
        ...
        <section className="soft-panel p-4">
          ...
          <label className="flex items-center gap-2 rounded-lg bg-black/15 px-3 py-2 text-sm text-slate-300">
          ...
          <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-white/[0.045] px-3 py-2 text-sm font-semibold text-slate-300 hover:bg-white/[0.08] hover:text-white">
            <X size={15} />
            Limpar
          </button>
          </div>
        ...
        <div className="panel hover-glow p-6 animate-fade-up">
        ...
        <div className="panel hover-glow p-6 animate-fade-up">
          ...
          <div className="space-y-2">
            ...
            {data && !data.activity.length ? (
              <div className="rounded-lg bg-white/[0.03] p-4 text-sm text-slate-400">
...
function FilterChip({ icon: Icon, label }: { icon: typeof Users; label: string }) {
  return (
    <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-vortex-bg/70 px-3 py-2 text-sm font-semibold text-slate-300 hover:bg-vortex-hover hover:text-white">
      <Icon size={15} />
      {label}
    </button>
  );
...
function ActivityRow({ item }: { item: Metrics['activity'][number] }) {
  ...
  return (
    <div className="group flex gap-3 rounded-lg bg-vortex-bg/55 p-3 transition duration-300 hover:bg-vortex-hover">
      <div className="relative h-11 w-11 shrink-0 overflow-hidden rounded-lg bg-white/[0.06] text-sm font-semibold text-slate-200">
