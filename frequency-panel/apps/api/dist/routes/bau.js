...
function findRepoRoot() {
    ...
    for (let index = 0; index < 8; index += 1) {
        if (fs.existsSync(path.join(current, 'commands')))
            return current;
...
function normalizeChest(guildData, chestKey) {
...
function pickGuildData(storage, requestedGuildId) {
