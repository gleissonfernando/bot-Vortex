...
const PANEL_THEME_TARGETS = [
  ...
  { key: 'ponto', label: 'Painel de ponto', description: 'Abrir, fechar e ajustar ponto' },
  { key: 'pontoStatus', label: 'Status do ponto', description: 'Painel de membros em servico' },
